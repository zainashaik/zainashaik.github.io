...
export declare function buildAppStaticPaths({ dir, page, distDir, dynamicIO, configFileName, segments, isrFlushToDisk, cacheHandler, cacheLifeProfiles, requestHeaders, maxMemoryCacheSize, fetchCacheKeyPrefix, nextConfigOutput, ComponentMod, isRoutePPREnabled, buildId, }: {
    dir: string;
    page: string;
    dynamicIO: boolean;
    configFileName: string;
...
export declare function isPageStatic({ dir, page, distDir, configFileName, runtimeEnvConfig, httpAgentOptions, locales, defaultLocale, parentId, pageRuntime, edgeInfo, pageType, dynamicIO, originalAppPath, isrFlushToDisk, maxMemoryCacheSize, nextConfigOutput, cacheHandler, cacheHandlers, cacheLifeProfiles, pprConfig, buildId, }: {
    dir: string;
    page: string;
    distDir: string;
    dynamicIO: boolean;
