        ...
        try {
            ...
            wasmBindings = {
                ...
                turbo: {
                    ...
                    createTurboTasks: function(_outputPath, _persistentCaching, _memoryLimit) {
                        throw new Error('`turbo.createTurboTasks` is not supported by the wasm bindings.');
                    },
    ...
    if (bindings) {
        nativeBindings = {
            ...
            turbo: {
                ...
                createTurboTasks (outputPath, persistentCaching, memoryLimit) {
                    return bindings.createTurboTasks(outputPath, persistentCaching, memoryLimit);
                },
