...
import type { ExternalObject, NextTurboTasks, RefCell } from './generated-native';
export interface Binding {
    isWasm: boolean;
    turbo: {
        startTrace(options: any, turboTasks: ExternalObject<NextTurboTasks>): any;
        createTurboTasks(outputPath: string, persistentCaching: boolean, memoryLimit?: number): ExternalObject<NextTurboTasks>;
