         ...
         */ if (/[\\\\/]_middleware$/.test(pageName)) {
            ...
            if (envChange || tsconfigChange) {
                ...
                if (envChange) {
                    ...
                    const { parsedEnv } = (0, _env.loadEnvConfig)(dir, true, _log, true, (envFilePath)=>{
            ...
            try {
                ...
                if ((frame == null ? void 0 : frame.lineNumber) && frameFile) {
                    if (hotReloader.turbopackProject) {
                        ...
                        const sourceMap = await (((_frame_file = frame.file) == null ? void 0 : _frame_file.startsWith(_path.default.sep)) || ((_frame_file1 = frame.file) == null ? void 0 : _frame_file1.startsWith('file:')) ? (0, _middleware.getSourceMapFromFile)(frame.file) : (0, _middleware.getSourceMapFromCompilation)(moduleId, compilation));
                        if (sourceMap) {
                            try {
