 ...
 */ async function warmupDevRender(req, ctx, requestStore, options) {
    ...
    // we can fill it.
    const devWarmupPrerenderResumeDataCache = (0, _resumedatacache.createPrerenderResumeDataCache)();
...
const renderToHTMLOrFlight = (req, res, pagePath, query, fallbackRouteParams, renderOpts, serverComponentsHmrCache, isDevWarmup)=>{
    ...
    const requestStore = (0, _requeststore.createRequestStoreForRender)(req, res, url, implicitTags, renderOpts.onUpdateCookies, renderResumeDataCache, renderOpts.previewProps, isHmrRefresh, serverComponentsHmrCache);
    ...
    return _workasyncstorageexternal.workAsyncStorage.run(workStore, ()=>{
        return _workunitasyncstorageexternal.workUnitAsyncStorage.run(requestStore, ()=>{
...
async function renderToStream(requestStore, req, res, ctx, workStore, tree, formState, postponedState) {
     ...
     */ const generateStaticHTML = renderOpts.supportsDynamicResponse !== true;
        ...
        if ((0, _notfound.isNotFoundError)(err)) {
            errorType = 'not-found';
            res.statusCode = 404;
        } else if ((0, _redirect.isRedirectError)(err)) {
            errorType = 'redirect';
