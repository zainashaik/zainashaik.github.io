...
import { TRACE_IGNORES, getFilesMapFromReasons, getHash } from './webpack/plugins/next-trace-entrypoints-plugin';
...
export async function collectBuildTraces({ dir, config, distDir, edgeRuntimeRoutes, staticPages, nextBuildSpan = new Span({
    name: 'build'
}), hasSsrAmpPages, buildTraceContext, outputFileTracingRoot, isFlyingShuttle }) {
    ...
    await nextBuildSpan.traceChild('node-file-trace-build', {
        ...
        }
        {
            ...
            await Promise.all([
                ...
                const curFileHashes = existingTrace.fileHashes;
                for (const file of [
                    ...entryNameFiles,
                    entryOutputPath
                ]){
