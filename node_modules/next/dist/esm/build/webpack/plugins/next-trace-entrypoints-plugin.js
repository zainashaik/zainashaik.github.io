...
export class TraceEntryPointsPlugin {
    ...
    async createTraceAssets(compilation, assets, span) {
        ...
        await span.traceChild('create-trace-assets').traceAsyncFn(async ()=>{
            ...
            const distDir = nodePath.join(outputPath, this.compilerType === 'server' ? '../..' : '../');
                        ...
                        if (this.flyingShuttle) {
                            ...
                            for (const item of curDepSet || []){
                                ...
                                if (!item.includes('?')) {
                                    ...
                                    const parentFiles = ((_parentFilesMap_get2 = parentFilesMap.get(nodePath.relative(this.tracingRoot, entry))) == null ? void 0 : _parentFilesMap_get2.entries()) || [];
