...
import { CLIENT_STATIC_FILES_PATH, COMPILER_NAMES, DEV_CLIENT_PAGES_MANIFEST, DEV_CLIENT_MIDDLEWARE_MANIFEST, PHASE_DEVELOPMENT_SERVER } from '../../../shared/lib/constants';
...
import { createOriginalStackFrame, getSourceMapFromCompilation, getSourceMapFromFile, parseStack } from '../../../client/components/react-dev-overlay/server/middleware';
            ...
            try {
                ...
                if ((frame == null ? void 0 : frame.lineNumber) && frameFile) {
                    if (hotReloader.turbopackProject) {
                        ...
                        const sourceMap = await (((_frame_file = frame.file) == null ? void 0 : _frame_file.startsWith(path.sep)) || ((_frame_file1 = frame.file) == null ? void 0 : _frame_file1.startsWith('file:')) ? getSourceMapFromFile(frame.file) : getSourceMapFromCompilation(moduleId, compilation));
                        if (sourceMap) {
                            try {
