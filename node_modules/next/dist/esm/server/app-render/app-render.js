...
export const renderToHTMLOrFlight = (req, res, pagePath, query, fallbackRouteParams, renderOpts, serverComponentsHmrCache, isDevWarmup)=>{
    if (!req.url) {
    ...
    if (typeof renderOpts.postponed === 'string') {
        if (fallbackRouteParams) {
            throw new InvariantError('postponed state should not be provided when fallback params are provided');
        }
    ...
    if ((postponedState == null ? void 0 : postponedState.renderResumeDataCache) && renderOpts.devWarmupRenderResumeDataCache) {
        throw new InvariantError('postponed state and dev warmup immutable resume data cache should not be provided together');
    }
    ...
    const requestStore = createRequestStoreForRender(req, res, url, implicitTags, renderOpts.onUpdateCookies, renderResumeDataCache, renderOpts.previewProps, isHmrRefresh, serverComponentsHmrCache);
