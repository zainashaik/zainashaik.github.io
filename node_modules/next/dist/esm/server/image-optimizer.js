...
export async function imageOptimizer(imageUpstream, paramsResult, nextConfig, isDev, previousCacheEntry) {
    ...
    const previouslyCachedImage = getPreviouslyCachedImageOrNull(imageUpstream, previousCacheEntry);
    if (previouslyCachedImage) {
        return {
            buffer: previouslyCachedImage.buffer,
            contentType,
            maxAge: (previousCacheEntry == null ? void 0 : previousCacheEntry.curRevalidate) || maxAge,
