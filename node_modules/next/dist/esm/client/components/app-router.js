...
import { getRedirectTypeFromError, getURLFromRedirectError, isRedirectError, RedirectType } from './redirect';
const globalMutable = {};
 ...
 */ function Router(param) {
   ...
   */ const appRouter = useMemo(()=>{
    ...
    const { cache, tree, nextUrl, focusAndScrollRef, buildId } = useUnwrapState(state);
