    ...
    return fetchServerAction(state, nextUrl, action).then(async (param)=>{
        ...
        for (const normalizedFlightData of flightData){
            ...
            if (cacheNodeSeedData !== null) {
                ...
                fillLazyItemsTillLeafWithHead(cache, // Existing cache is not passed in as server actions have to invalidate the entire cache.
        ...
        if (redirectLocation) {
            ...
            reject(getRedirectError(hasBasePath(newHref) ? removeBasePath(newHref) : newHref, redirectType || RedirectType.push));
        } else {
            resolve(actionResult);
        }
