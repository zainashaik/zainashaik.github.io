...
async function cliPrompt(cwd) {
    console.log(bold(`${cyan('?')} How would you like to configure ESLint? https://nextjs.org/docs/app/building-your-application/configuring/eslint`));
    try {
...
async function lint(baseDir, lintDirs, eslintrcFile, pkgJsonPath, { lintDuringBuild = false, eslintOptions = null, reportErrorsOnly = false, maxWarnings = -1, formatter = null, outputFile = null }) {
    try {
        ...
        if (nextEslintPluginIsEnabled) {
            ...
            Log.warn('');
            Log.warn('The Next.js plugin was not detected in your ESLint configuration. See https://nextjs.org/docs/app/building-your-application/configuring/eslint#migrating-existing-config');
        }
        ...
        if (config.exists) {
            ...
            if (lintDuringBuild) {
                ...
                if (selectedConfig == null) {
                    ...
                    Log.warn('If you set up ESLint yourself, we recommend adding the Next.js ESLint plugin. See https://nextjs.org/docs/app/building-your-application/configuring/eslint#migrating-existing-config');
                    return null;
                } else {
